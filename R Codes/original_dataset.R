...
# Load the dataset
df <- read.csv("dataset_cleaned.csv")
...
result_df <- data.frame(Model = "Original")
...
# Save to CSV
setwd(".")
write.csv(result_df, "fairness_results_original.csv", row.names = FALSE)

# Print to console
cat("✅ Fairness results for original dataset:\n")
print(result_df)
